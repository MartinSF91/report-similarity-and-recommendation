...
SELECT "GrossAdj_LW9"."DATREG" "c0",
       "GrossAdj_LW9"."Week" "c1",
       "GrossAdj_LW9"."CDC" "c2",
       "GrossAdj_LW9"."Package_ID" "c3",
       "GrossAdj_LW9"."Carrno" "c4",
       "GrossAdj_LW9"."Article" "c5",
       "GrossAdj_LW9"."Revision" "c6",
       "GrossAdj_LW9"."Qty" "c7",
       "GrossAdj_LW9"."TT_Code" "c8",
       "GrossAdj_LW9"."Type" "c9",
       "GrossAdj_LW9"."Code_Desc__G62T1_" "c10",
       "GrossAdj_LW9"."Multi_box_" "c11",
       "GrossAdj_LW9"."Num_PCS" "c12",
       "GrossAdj_LW9"."HFB" "c13",
       "GrossAdj_LW9"."HFB_Definition" "c14",
       "GrossAdj_LW9"."Pallet_Class" "c15",
       "GrossAdj_LW9"."Pick_MHA" "c16",
       "GrossAdj_LW9"."Buffer_MHA" "c17",
       "GrossAdj_LW9"."MHA" "c18",
       "GrossAdj_LW9"."Location" "c19",
       "GrossAdj_LW9"."User21" "c20",
       "GrossAdj_LW9"."Full_Name" "c21",
       "GrossAdj_LW9"."Profile" "c22",
       "GrossAdj_LW9"."Log_ID__X08T3_" "c23"
FROM
  (SELECT DISTINCT "SQL4"."DATREG" "DATREG",
                   "SQL4"."Week" "Week",
                   "SQL4"."CDC" "CDC",
                   "SQL4"."Package ID" "Package_ID",
                   "SQL4"."Carrno" "Carrno",
                   "SQL4"."Article" "Article",
                   "SQL4"."Revision" "Revision",
                   "SQL4"."TT Code" "TT_Code",
                   "SQL4"."Code Desc (G62T1)" "Code_Desc__G62T1_",
                   "SQL4"."Qty" "Qty",
                   "SQL4"."Multi-box?" "Multi_box_",
                   "SQL4"."Num PCS" "Num_PCS",
                   "SQL4"."HFB" "HFB",
                   "SQL4"."HFB Definition" "HFB_Definition",
                   "SQL4"."Pallet Class" "Pallet_Class",
                   "SQL4"."Pick MHA" "Pick_MHA",
                   "SQL4"."Buffer MHA" "Buffer_MHA",
                   "SQL4"."Type" "Type",
                   "SQL4"."MHA" "MHA",
                   "SQL4"."Location" "Location",
                   "SQL4"."User" "User21",
                   "SQL4"."Full Name" "Full_Name",
                   "SQL4"."Profile" "Profile",
                   "SQL4"."X08 SeqNo" "Log_ID__X08T3_"
   FROM
     (/*-


    SQL returns all CDC gross inventory adjustments
 from the previous workweek (Sun - Sat)
    ...
    */  SELECT l16.Datreg,
      ...
      WHERE x08.divcode = '025'
        ...
        AND x08rcode IN (437,
                         ...
                         461)
        AND g62.G62type > 1
        AND --x08.datreg >= (SELECT next_day(trunc(sysdate), 'Sondag') - 7 datstart FROM DUAL) AND
 ...
 TRIM (blockdsc) , X08Quant,
                   ...
                   END,
                   TRIM(x08.X08seqno)
      ORDER BY datreg ASC) "SQL4") "GrossAdj_LW9"
