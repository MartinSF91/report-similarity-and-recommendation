...
SELECT "Damages_LW9"."Date1" "c0",
       "Damages_LW9"."Week" "c1",
       "Damages_LW9"."CDC" "c2",
       "Damages_LW9"."Package_ID" "c3",
       "Damages_LW9"."Carrno" "c4",
       "Damages_LW9"."Article" "c5",
       "Damages_LW9"."Revision" "c6",
       "Damages_LW9"."Qty" "c7",
       "Damages_LW9"."TT_Code" "c8",
       "Damages_LW9"."Code_Desc__G62T1_" "c9",
       "Damages_LW9"."Type" "c10",
       "Damages_LW9"."Multi_box_" "c11",
       "Damages_LW9"."Num_PCS" "c12",
       "Damages_LW9"."HFB" "c13",
       "Damages_LW9"."HFB_Definition" "c14",
       "Damages_LW9"."Pallet_Class" "c15",
       "Damages_LW9"."Pick_MHA" "c16",
       "Damages_LW9"."Buffer_MHA" "c17",
       "Damages_LW9"."MHA" "c18",
       "Damages_LW9"."Location" "c19",
       "Damages_LW9"."User21" "c20",
       "Damages_LW9"."Full_Name" "c21",
       "Damages_LW9"."Profile" "c22",
       "Damages_LW9"."Log_ID__X08T3_" "c23"
FROM
  (SELECT DISTINCT "SQL5"."DATREG" "Date1",
                   "SQL5"."Week" "Week",
                   "SQL5"."CDC" "CDC",
                   ...
                   "SQL5"."X08 SeqNo" "Log_ID__X08T3_"
   FROM
     (/*-


    SQL returns all Damages Adjustments for previous week for 025 CDC
    ...
    */  SELECT l16.Datreg,
      ...
      INNER JOIN ast019.g62t1 g62 ON g62.blocked=x08.X08rcode
      LEFT JOIN ast019.l62t1 l62 ON l62.partno = x08.partno
      AND l62.partrev = x08.partrev
      AND l62.divcode = x08.divcode
      LEFT JOIN ast019.dwpactcp dwpcp ON dwpcp.itemno = x08.partno
      AND dwpcp.bucodsup = x08.partrev
      INNER JOIN ast019.l62t99 l629 ON l629.partno = l62.partno
      AND l629.partrev = l62.partrev
      AND l629.divcode = l62.divcode
      LEFT JOIN ast019.s90t1 s90 ON x08.logguser=s90.uname /*
    INNER JOIN ast019.dwpact dwpact
    		ON (dwpk.itemno = dwpact.itemno AND dwpk.bucodsup = dwpact.bucodsup AND dwpk.fpacdate = dwpact.fpacdate AND dwpk.reqdwpno = dwpact.reqdwpno AND	dwpk.reqdwped = dwpact.reqdwped)
    INNER JOIN ast019.dwpactul dwpul
    		ON (dwpk.itemno = dwpul.itemno AND dwpk.bucodsup = dwpul.bucodsup AND dwpk.fpacdate = dwpul.fpacdate AND dwpk.reqdwpno = dwpul.reqdwpno AND	dwpk.reqdwped = dwpul.reqdwped)
    */
 ...
 TRIM (blockdsc) , X08Quant,
                   ...
                   END,
                   TRIM(x08.X08seqno)
      ORDER BY datreg ASC) "SQL5") "Damages_LW9"
