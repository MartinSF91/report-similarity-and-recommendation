/* user=Piratla Manikanta reportPath= report= queryName=Abfrage1 REMOTE_ADDR= SERVER_NAME=cognosanalytics.apps.ikea.com requestID=j89sj8sM929jwMdy9wq9l4ldGCjMs4G4yl2C944h */ SELECT "TQ0_Abfrage1"."Consignment_Creator_BU_Type" AS "Consignment_Creator_BU_Type",
       ...
       CASE
           WHEN COUNT(DISTINCT CASE
                               ...
                               END) = '1'
                AND MIN("TQ0_Abfrage1"."ITEM_TYPE26") = 'ART' THEN 'Full Pallet'
           WHEN COUNT(DISTINCT CASE
                                   WHEN "TQ0_Abfrage1"."ITEM_NO" IS NULL
                                        OR "TQ0_Abfrage1"."ITEM_SUP_BU_CODE" IS NULL
                                        OR "TQ0_Abfrage1"."PROD_WEEK" IS NULL THEN NULL
                                   ELSE "TQ0_Abfrage1"."ITEM_NO" || "TQ0_Abfrage1"."ITEM_SUP_BU_CODE" || "TQ0_Abfrage1"."PROD_WEEK"
                               END) >= '1'
                AND MIN("TQ0_Abfrage1"."ITEM_TYPE26") = 'ART'
       ...
       "TQ0_Abfrage1"."Consignment_Latest_Major_Event_Code" AS "Consignment_Latest_Major_Event_Code",
       "TQ0_Abfrage1"."Consignment_Latest_Major_Event_Date" AS "Consignment_Latest_Major_Event_Date",
       "TQ0_Abfrage1"."Event_Name" AS "Event_Name",
       "TQ0_Abfrage1"."Last_Actual_Arrival_Date_Time" AS "Last_Actual_Arrival_Date_Time",
       "TQ0_Abfrage1"."Last_Estimated_Arrival_Date_Time" AS "Last_Estimated_Arrival_Date_Time",
...
GROUP BY "TQ0_Abfrage1"."Consignment_Creator_BU_Type",
         ...
         "TQ0_Abfrage1"."Consignment_Latest_Major_Event_Code",
         "TQ0_Abfrage1"."Consignment_Latest_Major_Event_Date",
         "TQ0_Abfrage1"."Event_Name",
         "TQ0_Abfrage1"."Last_Actual_Arrival_Date_Time",
         "TQ0_Abfrage1"."Last_Estimated_Arrival_Date_Time",
