...
FROM
 ...
 CASE
     ...
     WHEN l16.l16lcode||l16.l54movet||l16.l16destc = '4000'
          AND l16.ordtype != 12 THEN 'Loading: LSC'
     WHEN l16.l16lcode||l16.l54movet||l16.l16destc = '4000'
...
CASE
 ...
 END
                                              END AS "_UOM",
                                              COUNT(*) AS QTY
   FROM ast052.ASTRO_VIEW_CNT_SVL16001 l16
   INNER JOIN ast052.s90t1 s90 ON l16.logguser = s90.uname
   FULL OUTER JOIN ast052.l62t1 l62 ON l16.shortl62 = l62.shortl62
   WHERE l16.divcode != ' '
     AND s90.utype = 9
     AND l16.datreg >= sysdate -5 --Removed AND LENGTH(TRIM(s90.uname))<5
 ...
 CASE
     WHEN l16.l16lcode||l16.l54movet||l16.l16destc = '400'
          ...
          AND TRIM(l16.admunit) NOT IN ('CARTX',
                                        ...
                                        'GRN-N',
                                        'C&P-X',
                                        'C&P-N') THEN 'Order Pick: Yellow Line Discrete'
     WHEN l16.l16lcode||l16.l54movet||l16.l16destc = '400'
          AND l16.ordtype != 12
          AND substr(l16.routeno, 1, 4) IN ('1943',
                                            '1944')
          AND TRIM(l16.admunit) IN ('CARTX',
                                    'CARTN') THEN 'Order Pick: Yellow Line Cluster Cart'
     WHEN l16.l16lcode||l16.l54movet||l16.l16destc = '400'
          AND l16.ordtype != 12
          AND substr(l16.routeno, 1, 4) IN ('1943',
                                            '1944')
