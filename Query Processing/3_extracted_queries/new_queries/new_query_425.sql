SELECT "T0"."C0" "Auswertung_Datenelement1_2",
       "T0"."C1" "Summe_VICOrdLin_QtyPick_",
       "T0"."C0" "Summe_Datenelement1_",
       "T0"."C2" "ArtFea_ArticleName",
       "T0"."C3" "OrdLine_O08_ArtNo",
       "T0"."C1" "VICOrdLin_QtyPick",
       "T0"."C4" "ArtLoc_PickMha",
       "T0"."C5" "ArtFea_DefPallQty",
       "T0"."C0" "Datenelement1",
       "T0"."C6" "ARTBaNo",
       rank() OVER (
                    ORDER BY "T0"."C0" DESC NULLS LAST) "Datenelement3",
       "T0"."C7" "ArtFea_ClassPallet"
FROM
  (SELECT (sum("O08T15"."DELQUANT")/nullif(min("L62T16"."CQUANT"), 0))/12 "C0",
          sum("O08T15"."DELQUANT") "C1",
          "L62T16"."PARTDSC1" "C2",
          "O08T15"."PARTNO" "C3",
          "L62T16"."PMHA" "C4",
          "L62T16"."CQUANT" "C5",
