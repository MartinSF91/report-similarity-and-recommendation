...
FROM
  (SELECT AL1.BU_CODE_CRE_SHP||'-'||AL1.BU_TYPE_CRE_SHP||'-'||AL1.SHP_NO "Trid ID",
   ...
   WHERE AL2.SHP_NO=AL1.SHP_NO
     ...
     AND AL1.SHP_STAT NOT LIKE '60%') "SQL1" /* user=Vibhavari Bharat Nandre reportPath= report= queryName=Empties REMOTE_ADDR= SERVER_NAME=cognosanalytics.apps.ikea.com requestID=wjhy9yC9hq9h8G22wwljhhl9G4MvC9wvGGM8vvhh */
