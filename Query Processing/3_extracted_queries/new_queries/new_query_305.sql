...
FROM ast051.l16t3 l16
INNER JOIN ast051.l62t1 l62 ON (l16.shortl62 = l62.shortl62)
INNER JOIN ast051.g08t1 g08 ON (l16.carrno = g08.carrno)
INNER JOIN ast051.g08t90 g089 ON (g089.carrno = g08.carrno)
INNER JOIN ast051.dwpkey dwpk ON (g089.shortdwp = dwpk.shortdwp)
INNER JOIN ast051.dwpact dwpact ON (dwpk.itemno = dwpact.itemno
...
INNER JOIN ast051.g04t90 g04 ON (g04.shortg04 = l16.shortg04)
INNER JOIN ast051.g30t1 g30 ON (l16.shortg30 = g30.shortg30)
INNER JOIN
  (SELECT l16.shortg30,
