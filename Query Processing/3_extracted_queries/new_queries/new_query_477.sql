SELECT "SQL1"."Close Date" "Close_Date",
       ...
       "SQL1"."Pick Type" "Pick_Type",
       CASE
           WHEN "SQL1"."Astro Order Type"=12 THEN N'Parcel'
           WHEN "SQL1"."Receiver #" IN (25,
                                        51,
                                        57,
                                        960) THEN N'CDC'
           ELSE N'Store'
       END "c24",
       sum(round("SQL1"."Shipped Volume"/1000, 2)) "Shipped_Volume",
       ...
       sum(round("SQL1"."PAW OrderLine Sum", 2)) "PAW_Order_Lines",
       sum("SQL1"."MIP OrderLine Sum") "MIP_Order_Lines",
