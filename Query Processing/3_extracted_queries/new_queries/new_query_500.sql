/* user=Vibhavari Bharat Nandre reportPath= report= queryName=Query1 REMOTE_ADDR= SERVER_NAME=cognosanalytics.apps.ikea.com requestID=yqM4s29wsdhy42ljlsdMyM29jy9d4dG2qyjCqy8y */
...
WHERE "SHP"."LAST_STOP_BU_CODE" IN ('359',
                                    'MEE')
