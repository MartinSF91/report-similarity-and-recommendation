SELECT trim(BOTH
       ...
       END "min_pool_werte",
       to_number(CASE
                     WHEN "C_246Pool0530SQL"."CARRIER"='L.I.T. SPEDITIO'
                          AND "C_246Pool0530SQL"."LUTYPE"='T100' THEN '14'
                     WHEN "C_246Pool0530SQL"."CARRIER"='L.I.T. SPEDITIO'
                          AND "C_246Pool0530SQL"."LUTYPE"='T110' THEN '7'
                     WHEN "C_246Pool0530SQL"."CARRIER"='BLG Cargo Logis'
                          AND "C_246Pool0530SQL"."LUTYPE"='T90' THEN '0'
                     WHEN "C_246Pool0530SQL"."CARRIER"='BLG Cargo Logis'
                          AND "C_246Pool0530SQL"."LUTYPE"='T100' THEN '2'
                     WHEN "C_246Pool0530SQL"."CARRIER"='BLG Cargo Logis'
                          AND "C_246Pool0530SQL"."LUTYPE"='S45' THEN '3'
                     WHEN "C_246Pool0530SQL"."CARRIER"='BLG Cargo Logis'
                          AND "C_246Pool0530SQL"."LUTYPE"='C45HPW' THEN '2'
                     WHEN "C_246Pool0530SQL"."CARRIER"='UAB Girteka log'
                          AND "C_246Pool0530SQL"."LUTYPE"='T100' THEN '17'
                     WHEN "C_246Pool0530SQL"."CARRIER"='GARTNER'
                          AND "C_246Pool0530SQL"."LUTYPE"='T110' THEN '44'
                     WHEN "C_246Pool0530SQL"."CARRIER"='GARTNER'
                          AND "C_246Pool0530SQL"."LUTYPE"='T90' THEN '5'
                     WHEN "C_246Pool0530SQL"."CARRIER"='NOTHEGGER TRANS'
                          AND "C_246Pool0530SQL"."LUTYPE"='C45HPW' THEN '6'
                 END) "Min__Pool"
...
WHERE "C_246Pool0530SQL"."CARRIER"='BLG Cargo Logis'
  ...
  OR "C_246Pool0530SQL"."CARRIER"='GARTNER'
  AND "C_246Pool0530SQL"."LUTYPE"='T90'
  OR "C_246Pool0530SQL"."CARRIER"='L.I.T. SPEDITIO'
  AND "C_246Pool0530SQL"."LUTYPE"='T100'
  OR "C_246Pool0530SQL"."CARRIER"='L.I.T. SPEDITIO'
  AND "C_246Pool0530SQL"."LUTYPE"='T110'
GROUP BY trim(BOTH
