SELECT CASE
       ...
       COUNT(CASE
                 WHEN to_char(datreg, 'hh24:mi') >= '05:00'
                      AND to_char(datreg, 'hh24:mi') < '06:00' THEN l16seqno
             END)"05:00-05:59", --COUNT(CASE WHEN to_char(datreg,'hh24:mi') >= '06:00' and to_char(datreg,'hh24:mi') <= '14:00' THEN l16seqno END)"_Fruhschicht",
 COUNT(CASE
           WHEN to_char(datreg, 'hh24:mi') >= '06:00'
 ...
 COUNT(CASE
           WHEN to_char(datreg, 'hh24:mi') >= '13:00'
                AND to_char(datreg, 'hh24:mi') < '14:00' THEN l16seqno
       END)"13:00-13:59", --COUNT(CASE WHEN to_char(datreg,'hh24:mi') >= '14:00' and to_char(datreg,'hh24:mi') <= '22:00' THEN l16seqno END)"_Spatschicht",
 COUNT(CASE
           WHEN to_char(datreg, 'hh24:mi') >= '14:00'
