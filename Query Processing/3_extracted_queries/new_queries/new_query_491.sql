...
FROM "BO_DISPATCH_V" "BO_DISPATCH_V",
     "BO_ORDERS_V" "BO_ORDERS_V",
     "ART_SUP" "ART_SUP",
     "BO_DISPATCHUNIT_V" "BO_DISPATCHUNIT_V"
WHERE "BO_ORDERS_V"."ART_QTY"<"ART_SUP"."ART_QTY_PALL"
  ...
  AND "BO_DISPATCH_V"."ARC_DATE_FILLED"="BO_DISPATCHUNIT_V"."ARC_DATE_FILLED"
  AND "BO_DISPATCH_V"."DSP_NO"="BO_DISPATCHUNIT_V"."DSP_NO"
  AND "BO_ORDERS_V"."DSPUNIT_NO"="BO_DISPATCHUNIT_V"."DSPUNIT_NO"
  ...
  AND "ART_SUP"."ART_NO"="BO_ORDERS_V"."ART_NO"
